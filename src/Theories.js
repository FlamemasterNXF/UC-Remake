...
function calculateTheoryEffects(){
    ...
    theoryEffects[2] = data.hasTheory[2] ? data.derivs[0].b.gte(1) ? D(data.derivs[0].b.sqrt().plus(1).times(lostRewards[0])) : D(1) : D(1)
    ...
    theoryEffects[5] = data.hasTheory[5] ? data.derivs[3].b.gte(1) ? D(data.upgrades[0].amt.plus(data.upgrades[1].amt).plus(data.upgrades[2].amt).plus(data.upgrades[3].amt)).sqrt().times(lostRewards[1]) : D(1) : D(1)
    theoryEffects[6] = data.hasTheory[6] ? data.derivs[0].b.gte(1) ? D(data.derivs[0].b.sqrt().plus(1)).div(lostRewards[1]) : D(1) : D(1)
    theoryEffects[7] = data.hasTheory[7] ? data.derivs[0].b.gte(1) ? D(data.derivs[0].b.sqrt().plus(1).times(lostRewards[0])) : D(1) : D(1)
