...
function calculateStairStuff(){
    ...
    secretEnergyGain[0] = data.stairsComplete.plus(1).sub(data.stairSecretEnergy[0].sub(1).sqrt().div(100))
    secretEnergyGain[1] = data.stairsComplete.plus(1).div(100).sub(data.stairSecretEnergy[1].sub(1).sqrt().div(1000))
    secretEnergyGain[2] = data.stairsComplete.plus(1).div(10).sub(data.stairSecretEnergy[2].sub(1).sqrt().div(100))
    secretEnergyGain[3] = data.stairsComplete.plus(2).log10().sub(data.stairSecretEnergy[3].sub(1).sqrt().div(100))
    ...
    secretEnergyGain[7] = data.stairsComplete.gte(4)?data.stairsComplete.sub(3).sub(data.stairSecretEnergy[7].sqrt().div(100)):D(0)
