...
function updateHTML(){
    ...
    document.getElementById("derivI").innerHTML = `Cost: ${format(data.derivs[0].c)} Oddities<br>[${format(data.derivs[0].b)}] ${format(data.derivs[0].amt)}<br>Produces ${format(upgradeEffects[0])} Oddities [${format(data.oddityGain)}/s]`
